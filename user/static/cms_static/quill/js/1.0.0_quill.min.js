...
! function(t, e) {
	...
	return function(t) {
		...
		}), i["default"].register(u["default"], f["default"], y["default"], m["default"], O["default"], x["default"]), t.exports = a["default"]
	}, function(t, e, n) {
		"use strict";
		var r = n(3),
			o = n(7),
				...
				return o(e, t), e.prototype.appendChild = function(t) {
					...
					t.prototype.attach.call(this), this.children = new i["default"], [].slice.call(this.domNode.childNodes).reverse().forEach(function(t) {
						try {
							...
							if (o instanceof a.ParchmentError) return;
							throw o
						}
					})
				}, e.prototype.deleteAt = function(t, e) {
					return 0 === t && e === this.length() ? this.remove() : void this.children.forEachAt(t, e, function(t, e, n) {
						t.deleteAt(e, n)
					})
		...
		function n(t, e) {
			...
			var r = n,
				i = t instanceof Node ? t : r.create(e);
			return new r(i, e)
		}
		...
		function o(t, e) {
			void 0 === e && (e = h.ANY);
			var n;
			if ("string" == typeof t) n = f[t] || s[t];
			else if (t instanceof Text) n = f.text;
		...
		function i() {
			...
			if (f[n.blotName || n.attrName] = n, "string" == typeof n.keyName) s[n.keyName] = n;
		...
		var h = e.Scope;
		e.create = n, e.find = r, e.query = o, e.register = i
	}, function(t, e, n) {
		"use strict";
		...
		var r = n(6),
			o = function() {
				...
				return t.keys = function(t) {
					...
					return null != n && (null == this.whitelist || this.whitelist.indexOf(e) > -1)
				}, t.prototype.remove = function(t) {
		...
		var o = this && this.__extends || function(t, e) {
			...
			l = function(t) {
				...
				return o(e, t), e.keys = function(t) {
					...
					var e = r(t, this.keyName);
					e.forEach(function(e) {
						t.classList.remove(e)
					}), 0 === t.classList.length && t.removeAttribute("class")
				}, e.prototype.value = function(t) {
					var e = r(t, this.keyName)[0] || "";
					return e.slice(this.keyName.length + 1)
				}, e
			}(i["default"]);
		Object.defineProperty(e, "__esModule", {
			value: !0
			...
			s = function(t) {
				...
				return r(e, t), e.prototype.detach = function() {
					...
					for (var r = function(t, e) {
						...
						}, s = e, u = 0; s.length > 0; u += 1) {
						if (u >= a) throw new Error("[Parchment] Maximum optimize iterations reached");
						...
						}), this.children.forEach(l), s = this.observer.takeRecords(), e.push.apply(e, s)
					}
				}, e.prototype.update = function(e) {
					var n = this;
					e = e || this.observer.takeRecords(), e.map(function(t) {
						var e = i.find(t.target, !0);
		...
		function i(t, e) {
			if (e = (0, k["default"])(!0, {
				...
				}, e), null == e.theme || e.theme === T.DEFAULTS.theme) e.theme = N["default"];
			else if (e.theme = T["import"]("themes/" + e.theme), null == e.theme) throw new Error("Invalid theme " + e.theme + ". Did you register it?");
			var n = (0, k["default"])(!0, {}, e.theme.DEFAULTS);
			[n, e].forEach(function(t) {
				t.modules = t.modules || {}, Object.keys(t.modules).forEach(function(e) {
					t.modules[e] === !0 && (t.modules[e] = {})
				})
			});
			var r = Object.keys(n.modules).concat(Object.keys(e.modules)),
				o = r.reduce(function(t, e) {
					var n = T["import"]("modules/" + e);
					return null == n ? q.error("Cannot load " + e + " module. Are you sure you registered it?") : t[e] = n.DEFAULTS || {}, t
				}, {});
		...
		function l(t, e, n, r, o) {
			var i = {};
			return "number" == typeof t.index && "number" == typeof t.length ? "number" != typeof e ? (o = r, r = n, n = e, e = t.length, t = t.index) : (e = t.length, t = t.index) : "number" != typeof e && (o = r, r = n, n = e, e = 0), "object" === ("undefined" == typeof n ? "undefined" : s(n)) ? (i = n, o = r) : "string" == typeof n && (null != r ? i[n] = r : o = n), o = o || v["default"].sources.API, [t, e, i, o]
		}
		...
		function a(t, e, n, r) {
			...
			if (e instanceof h["default"]) {
				var l = [t.index, t.index + t.length].map(function(t) {
						return e.transformPosition(t, r === v["default"].sources.USER)
					}),
					a = u(l, 2);
				o = a[0], i = a[1]
			} else {
				var s = [t.index, t.index + t.length].map(function(t) {
						return t < e || t === e && r !== v["default"].sources.USER ? t : n >= 0 ? t + n : Math.max(e, t + n)
					}),
					c = u(s, 2);
				o = c[0], i = c[1]
			}
			return new O.Range(o, i - o)
		}
		Object.defineProperty(e, "__esModule", {
			value: !0
		...
		var f = n(20),
			...
			T = function() {
				function t(e) {
					...
					if (o(this, t), r = i(e, r), this.container = r.container, null == this.container) return q.error("Invalid Quill container", e);
					r.debug && t.debug(r.debug);
					var l = this.container.innerHTML.trim();
					this.container.classList.add("ql-container"), this.container.innerHTML = "", this.root = this.addContainer("ql-editor"), this.emitter = new v["default"], this.scroll = _["default"].create(this.root, {
						emitter: this.emitter,
						whitelist: r.formats
					}), this.editor = new d["default"](this.scroll, this.emitter), this.selection = new w["default"](this.scroll, this.emitter), this.theme = new r.theme(this, r), this.keyboard = this.theme.addModule("keyboard"), this.clipboard = this.theme.addModule("clipboard"), this.history = this.theme.addModule("history"), this.theme.init(), this.pasteHTML("<div class='ql-editor' style=\"white-space: normal;\">" + l + "<p><br></p></div>"), this.history.clear(), r.readOnly && this.disable(), r.placeholder && this.root.setAttribute("data-placeholder", r.placeholder), this.root.classList.toggle("ql-blank", this.editor.isBlank()), this.emitter.on(v["default"].events.TEXT_CHANGE, function(t) {
				...
				return c(t, null, [{
					...
					key: "import",
					value: function(t) {
						return null == this.imports[t] && q.error("Cannot import " + t + ". Are you sure it was registered?"), this.imports[t]
					}
				}, {
					key: "register",
					value: function(t, e) {
						...
						} else null == this.imports[t] || r || q.warn("Overwriting " + t + " with", e), this.imports[t] = e, (t.startsWith("blots/") || t.startsWith("formats/")) && "abstract" !== e.blotName && _["default"].register(e)
					}
				}]), c(t, [{
					key: "addContainer",
					value: function(t) {
					...
					value: function(t, e, n) {
						...
						return i = a(i, t, -1 * e, n), this.setSelection(i, v["default"].sources.SILENT), s
					}
				}, {
					key: "disable",
					value: function() {
					...
					key: "format",
					value: function(t, e) {
						var n = arguments.length <= 2 || void 0 === arguments[2] ? v["default"].sources.API : arguments[2],
							r = this.getSelection(!0),
							o = new h["default"];
						if (null == r) return o;
						if (_["default"].query(t, _["default"].Scope.BLOCK)) o = this.formatLine(r, t, e, n);
						else {
							if (0 === r.length) return this.selection.format(t, e), o;
							o = this.formatText(r, t, e, n)
						}
						return this.setSelection(r, v["default"].sources.SILENT), o
					}
				}, {
					key: "formatLine",
					value: function(t, e, n, r, o) {
						...
						return this.selection.setRange(c, !0, v["default"].sources.SILENT), this.selection.scrollIntoView(), f
					}
				}, {
					key: "formatText",
					value: function(t, e, n, r, o) {
					...
					value: function(e, n, r) {
						...
						return i = a(i, l, o), this.setSelection(i, v["default"].sources.SILENT), l
					}
				}, {
					key: "insertText",
					value: function(t, e, n, r, o) {
						...
						return s = a(s, t, e.length, o), this.setSelection(s, v["default"].sources.SILENT), h
					}
				}, {
					key: "off",
					value: function() {
					...
					value: function(t, e) {
						...
						return this.updateContents((new h["default"]).retain(t).concat(r), n)
					}
				}, {
					key: "removeFormat",
					value: function(t, e, n) {
						...
						return r = a(r, s, n), this.setSelection(r, v["default"].sources.SILENT), s
					}
				}, {
					key: "setContents",
					value: function(t) {
						var e = arguments.length <= 1 || void 0 === arguments[1] ? v["default"].sources.API : arguments[1];
						t = new h["default"](t).slice();
						var n = t.ops[t.ops.length - 1];
					...
					value: function(e, n, r) {
						if (null == e) this.selection.setRange(null, n || t.sources.API);
							...
							var o = l(e, n, r),
								i = u(o, 4);
							e = i[0], n = i[1], r = i[3], this.selection.setRange(new O.Range(e, n), r)
						}
					...
					key: "update",
					value: function() {
						var t = arguments.length <= 0 || void 0 === arguments[0] ? v["default"].sources.USER : arguments[0],
					...
					value: function(t) {
						var e = arguments.length <= 1 || void 0 === arguments[1] ? v["default"].sources.API : arguments[1],
							n = this.getSelection();
						Array.isArray(t) && (t = new h["default"](t.slice()));
						var r = this.editor.applyDelta(t, e);
						return null != n && (n = a(n, r, e), this.setSelection(n, v["default"].sources.SILENT)), r
					}
				}]), t
			}();
		T.DEFAULTS = {
			...
			readOnly: !1,
			theme: "default"
		}, T.events = v["default"].events, T.sources = v["default"].sources, T.version = "1.0.0", T.imports = {
			delta: h["default"],
			parchment: _["default"],
			"core/module": g["default"],
			"core/theme": N["default"]
		}, e.expandConfig = i, e.overload = l, e["default"] = T
	}, function(t, e) {
		"use strict";
		...
		n.classList.toggle("test-class", !1), n.classList.contains("test-class") && ! function() {
			...
			value: function r(t) {
				...
				for (var r, e = Object(this), n = e.length >>> 0, o = arguments[1], i = 0; i < n; i++)
					if (r = e[i], t.call(o, r, i, e)) return r
			}
		...
		function n(t, e) {
			...
			var n = l(t, e),
				o = t.substring(0, n);
			t = t.substring(n), e = e.substring(n), n = a(t, e);
		...
		function o(t, e) {
			...
			for (var p = n - r, d = p % 2 != 0, y = 0, v = 0, b = 0, g = 0, m = 0; m < o; m++) {
				...
				for (var j = -m + b; j <= m - g; j += 2) {
					var E, k = l + j;
					E = j == -m || j != m && u[k - 1] < u[k + 1] ? u[k + 1] : u[k - 1] + 1;
					for (var A = E - j; E < n && A < r && t.charAt(n - E - 1) == e.charAt(r - A - 1);) E++, A++;
					if (u[k] = E, E > n) g += 2;
					else if (A > r) b += 2;
					else if (!d) {
						var w = l + p - j;
		...
		function s(t, e) {
			function n(t, e, n) {
				for (var r, o, i, s, u = t.substring(n, n + Math.floor(t.length / 4)), c = -1, f = "";
					(c = e.indexOf(u, c + 1)) != -1;) {
			...
			var c, f, h, p;
			t.length > e.length ? (c = i[0], f = i[1], h = i[2], p = i[3]) : (h = i[0], p = i[1], c = i[2], f = i[3]);
			var d = i[4];
			return [c, f, h, p, d]
		}
		...
		function u(t) {
			...
			for (var e, n = 0, r = 0, o = 0, i = "", s = ""; n < t.length;) switch (t[n][0]) {
				...
				case c:
					...
					break;
				case h:
					r + o > 1 ? (0 !== r && 0 !== o && (e = l(s, i), 0 !== e && (n - r - o > 0 && t[n - r - o - 1][0] == h ? t[n - r - o - 1][1] += s.substring(0, e) : (t.splice(0, 0, [h, s.substring(0, e)]), n++), s = s.substring(e), i = i.substring(e)), e = a(s, i), 0 !== e && (t[n][1] = s.substring(s.length - e) + t[n][1], s = s.substring(0, s.length - e), i = i.substring(0, i.length - e))), 0 === r ? t.splice(n - o, r + o, [f, s]) : 0 === o ? t.splice(n - r, r + o, [c, i]) : t.splice(n - r - o, r + o, [c, i], [f, s]), n = n - r - o + (r ? 1 : 0) + (o ? 1 : 0) + 1) : 0 !== n && t[n - 1][0] == h ? (t[n - 1][1] += t[n][1], t.splice(n, 1)) : n++, o = 0, r = 0, i = "", s = ""
			}
		...
		t.exports = function l() {
			var t, e, n, r, a, s, u = arguments[0],
				c = 1,
				f = arguments.length,
				h = !1;
			for ("boolean" == typeof u ? (h = u, u = arguments[1] || {}, c = 2) : ("object" != typeof u && "function" != typeof u || null == u) && (u = {}); c < f; ++c)
				if (t = arguments[c], null != t)
					for (e in t) n = u[e], r = t[e], u !== r && (h && r && (i(r) || (a = o(r))) ? (a ? (a = !1, s = n && o(n) ? n : []) : s = n && i(n) ? n : {}, u[e] = l(h, s, r)) : "undefined" != typeof r && (u[e] = r));
			return u
		}
	}, function(t, e, n) {
		function r(t) {
		...
		function a(t) {
			return t.ops.reduce(function(t, e) {
				...
				if (null == e.attributes || e.attributes.list !== !0 && e.attributes.bullet !== !0 || (e = (0, j["default"])(e), e.attributes.list ? e.attributes.list = "ordered" : (e.attributes.list = "bullet", delete e.attributes.bullet)), "string" == typeof e.insert) {
		...
		var s = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
			...
			S = function() {
				function t(e, n) {
					i(this, t), this.scroll = e, this.emitter = n, this.emitter.on(v["default"].events.SCROLL_UPDATE, this.update.bind(this, null)), this.delta = this.getDelta(), this.enable()
				}
				return c(t, [{
					key: "applyDelta",
					value: function(t) {
						var e = this,
							n = arguments.length <= 1 || void 0 === arguments[1] ? v["default"].sources.API : arguments[1],
							r = !1;
						this.scroll.update();
						var o = this.scroll.length();
						return this.scroll.batch = !0, t = a(t), t.ops.reduce(function(t, n) {
							...
							if (null != n.insert) {
								if ("string" == typeof n.insert) {
									...
									var c = e.scroll.line(t),
										...
										h = f[0],
										p = f[1],
										y = (0, T["default"])({}, (0, x.bubbleFormats)(h));
									if (h instanceof k["default"]) {
										var v = h.descendant(g["default"].Leaf, p),
											b = u(v, 1),
											m = b[0];
										y = (0, T["default"])(y, (0, x.bubbleFormats)(m))
									}
									l = d["default"].attributes.diff(y, l) || {}
								} else if ("object" === s(n.insert)) {
									var _ = Object.keys(n.insert)[0];
									if (null == _) return t;
									e.scroll.insertAt(t, _, n.insert[_])
								}
								o += i
							}
					...
					value: function(t, e) {
						var n = arguments.length <= 2 || void 0 === arguments[2] ? v["default"].sources.API : arguments[2];
						return this.scroll.deleteAt(t, e), this.update((new h["default"]).retain(t)["delete"](e), n)
					}
				}, {
					key: "enable",
					value: function() {
					...
					value: function(t, e) {
						var n = this,
							r = arguments.length <= 2 || void 0 === arguments[2] ? {} : arguments[2],
							o = arguments.length <= 3 || void 0 === arguments[3] ? v["default"].sources.API : arguments[3];
						...
						}), this.scroll.optimize(), this.update((new h["default"]).retain(t).retain(e, (0, j["default"])(r)), o)
					}
				}, {
					key: "formatText",
					value: function(t, e) {
						...
						}), this.update((new h["default"]).retain(t).retain(e, (0, j["default"])(r)), o)
					}
				}, {
					key: "getContents",
					value: function(t, e) {
					...
					value: function(t) {
						...
						0 === e ? this.scroll.path(t).forEach(function(t) {
							var e = u(t, 1),
								o = e[0];
							o instanceof k["default"] ? n.push(o) : o instanceof g["default"].Leaf && r.push(o)
						}) : (n = this.scroll.lines(t, e), r = this.scroll.descendants(g["default"].Leaf, t, e));
						var o = [n, r].map(function(t) {
							if (0 === t.length) return {};
							for (var e = (0, x.bubbleFormats)(t.shift()); Object.keys(e).length > 0;) {
								var n = t.shift();
								if (null == n) return e;
								e = l((0, x.bubbleFormats)(n), e)
							}
							return e
						});
					...
					key: "insertEmbed",
					value: function(t, e, n) {
						var r = arguments.length <= 3 || void 0 === arguments[3] ? v["default"].sources.API : arguments[3];
						return this.scroll.insertAt(t, e, n), this.update((new h["default"]).retain(t).insert(o({}, e, n)), r)
					}
				}, {
					key: "insertText",
					value: function(t, e) {
						...
						}), this.update((new h["default"]).retain(t).insert(e, (0, j["default"])(r)), o)
					}
				}, {
					key: "isBlank",
					value: function() {
					...
					value: function(t, e, n) {
						var r = this.getText(t, e),
							...
							s = 0,
							c = new h["default"];
						null != l && (s = l instanceof _["default"] ? l.newlineIndex(a) - a + 1 : l.length() - a, c = l.delta().slice(a, a + s - 1).insert("\n"));
						var f = this.getContents(t, e + s),
							p = f.diff((new h["default"]).insert(r).concat(c)),
							d = (new h["default"]).retain(t).concat(p);
						return this.applyDelta(d, n)
					}
				}, {
					key: "update",
					value: function(t) {
						var e = this,
							n = arguments.length <= 1 || void 0 === arguments[1] ? v["default"].sources.USER : arguments[1],
							r = arguments.length <= 2 || void 0 === arguments[2] ? [] : arguments[2],
							o = this.delta;
						if (1 === r.length && "characterData" === r[0].type && g["default"].find(r[0].target) ? ! function() {
								var n = g["default"].find(r[0].target),
									i = (0, x.bubbleFormats)(n),
									l = n.offset(e.scroll),
									a = r[0].oldValue.replace(w["default"].CONTENTS, ""),
									s = (new h["default"]).insert(a),
									u = (new h["default"]).insert(n.value()),
									c = (new h["default"]).retain(l).concat(s.diff(u));
								t = c.ops.reduce(function(t, e) {
									return e.insert ? t.insert(e.insert, i) : t.push(e)
								}, new h["default"]), e.delta = o.compose(t)
							}() : (this.delta = this.getDelta(), t && (0, N["default"])(o.compose(t), this.delta) || (t = o.diff(this.delta))), t.length() > 0) {
							var i, l = [v["default"].events.TEXT_CHANGE, t, o, n];
							if ((i = this.emitter).emit.apply(i, [v["default"].events.EDITOR_CHANGE].concat(l)), n !== v["default"].sources.SILENT) {
								var a;
		...
		r.prototype._events = void 0, r.prototype.eventNames = function() {
			...
			r.prototype.setMaxListeners = function() {
				return this
			}, r.prefixed = i, "undefined" != typeof t && (t.exports = r)
	}, function(t, e) {
		"use strict";
		...
		var O = function(t) {
			...
			return l(e, t), s(e, [{
				...
				key: "length",
				value: function n() {
					var n = this.domNode.textContent.length;
				...
				return l(e, t), s(e, [{
					...
					value: function(t, n, r) {
						if ("string" == typeof n && n.endsWith("\n")) {
							var o = y["default"].create(j.blotName);
		...
		var j = function(t) {
			...
			return l(e, t), s(e, [{
				...
				key: "length",
				value: function() {
					return null == this.cache.length && (this.cache.length = u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "length", this).call(this) + k), this.cache.length
				}
			}, {
				key: "moveChildren",
				value: function(t, n) {
		...
		j.blotName = "block", j.tagName = "P", j.defaultChild = "break", j.allowedChildren = [O["default"], m["default"], x["default"]], e.bubbleFormats = a, e.BlockEmbed = E, e["default"] = j
	}, function(t, e, n) {
		"use strict";
		...
		var a = function() {
			...
			f = function(t) {
				...
				return l(e, t), a(e, [{
					key: "insertInto",
					value: function(t, n) {
						0 === t.children.length && s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "insertInto", this).call(this, t, n)
					}
				}, {
					key: "length",
					value: function() {
		...
		var a = function() {
			...
			v = function(t) {
				...
				return l(e, t), a(e, [{
					key: "formatAt",
					value: function(t, n, r, o) {
						if (e.compare(this.statics.blotName, r) < 0 && y["default"].query(r, y["default"].Scope.BLOT)) {
		...
		v.allowedChildren = [v, f["default"], p["default"]], v.order = ["cursor", "inline", "code", "underline", "strike", "italic", "bold", "script", "link"], e["default"] = v
	}, function(t, e, n) {
		"use strict";
				...
				return l(e, t), u(e, null, [{
					...
					value: function() {
						...
						if (!this.selection.composing && null != this.parent) {
							...
							this.textNode.data !== e.CONTENTS && (this.textNode.data = this.textNode.data.split(e.CONTENTS).join(""), this.parent.insertBefore(f["default"].create(this.textNode), this), this.textNode = document.createTextNode(e.CONTENTS), this.domNode.appendChild(this.textNode)), this.remove(), null != r && r.start.node === n && r.end.node === n && this.selection.emitter.once(y["default"].events.SCROLL_OPTIMIZE, function() {
		...
		v.blotName = "cursor", v.className = "ql-cursor", v.tagName = "span", v.CONTENTS = "\ufeff", e["default"] = v
	}, function(t, e) {
		var n = function() {
			"use strict";
			...
			function t(e, n, r, o) {
				function l(e, r) {
					...
					if (t.__isArray(e)) a = [];
					else if (t.__isRegExp(e)) a = new RegExp(e.source, i(e)), e.lastIndex && (a.lastIndex = e.lastIndex);
					else if (t.__isDate(e)) a = new Date(e.getTime());
					else {
						if (c && Buffer.isBuffer(e)) return a = new Buffer(e.length), e.copy(a), a;
						"undefined" == typeof o ? (f = Object.getPrototypeOf(e), a = Object.create(f)) : (a = Object.create(o), f = o)
					}
					if (n) {
						var h = s.indexOf(e);
						if (h != -1) return u[h];
					...
					for (var p in e) {
						var d;
						f && (d = Object.getOwnPropertyDescriptor(f, p)), d && null == d.set || (a[p] = l(e[p], r - 1))
					}
					return a
				}
				var a;
				"object" == typeof n && (r = n.depth, o = n.prototype, a = n.filter, n = n.circular);
				var s = [],
					u = [],
					c = "undefined" != typeof Buffer;
				return "undefined" == typeof n && (n = !0), "undefined" == typeof r && (r = 1 / 0), l(e, r)
			}
			...
			}, t.__objToStr = e, t.__isDate = n, t.__isArray = r, t.__isRegExp = o, t.__getRegExpFlags = i, t
		}();
		...
		var r = function o(t) {
			var e = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1];
			n(this, o), this.quill = t, this.options = e
		};
		...
		var a = function() {
			...
			O = function x(t) {
				var e = arguments.length <= 1 || void 0 === arguments[1] ? 0 : arguments[1];
				i(this, x), this.index = t, this.length = e
			},
			w = function() {
				function t(e, n) {
					var r = this;
					i(this, t), this.emitter = n, this.scroll = e, this.composing = !1, this.root = this.scroll.domNode, this.root.addEventListener("compositionstart", function() {
						...
						r.composing = !1
					}), this.cursor = c["default"].create("cursor", this), this.lastRange = this.savedRange = new O(0, 0), ["keyup", "mouseup", "mouseleave", "touchend", "touchleave", "focus", "blur"].forEach(function(t) {
						r.root.addEventListener(t, function() {
							setTimeout(r.update.bind(r, b["default"].sources.USER), 100)
						})
						...
						null != t && t.start.node !== r.cursor.textNode && r.emitter.once(b["default"].events.SCROLL_UPDATE, function() {
							try {
				...
				return s(t, [{
							...
							if (null != e)
								if (this.root.offsetHeight < e.bottom) {
									var n = this.scroll.line(Math.min(t.index + t.length, this.scroll.length() - 1)),
										r = a(n, 1),
										o = r[0];
									this.root.scrollTop = o.domNode.offsetTop + o.domNode.offsetHeight - this.root.offsetHeight
								} else if (e.top < 0) {
								var i = this.scroll.line(Math.min(t.index, this.scroll.length() - 1)),
									l = a(i, 1),
									s = l[0];
								this.root.scrollTop = s.domNode.offsetTop
							}
						}
					}
				}, {
					...
					value: function(t) {
						var e = this,
							...
							r = arguments.length <= 2 || void 0 === arguments[2] ? b["default"].sources.API : arguments[2];
						"string" == typeof n && (r = n, n = !1), _.info("setRange", t), null != t ? ! function() {
					...
					key: "update",
					value: function() {
						var t = arguments.length <= 0 || void 0 === arguments[0] ? b["default"].sources.USER : arguments[0],
							e = void 0,
							n = this.lastRange,
							r = this.getRange(),
							o = a(r, 2);
						if (this.lastRange = o[0], e = o[1], null != this.lastRange && (this.savedRange = this.lastRange), !(0, d["default"])(n, this.lastRange)) {
							var i;
							!this.composing && null != e && e["native"].collapsed && e.start.node !== this.cursor.textNode && this.cursor.restore();
							var l = [b["default"].events.SELECTION_CHANGE, (0, h["default"])(this.lastRange), (0, h["default"])(n), t];
							if ((i = this.emitter).emit.apply(i, [b["default"].events.EDITOR_CHANGE].concat(l)), t !== b["default"].sources.SILENT) {
								var s;
				...
				return l(e, t), u(e, [{
					...
					value: function(t, n) {
						var r = this.line(t),
							...
							u = s(a, 1),
							f = u[0];
						if (c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "deleteAt", this).call(this, t, n), null != f && i !== f && l > 0 && !(i instanceof y.BlockEmbed) && !(f instanceof y.BlockEmbed)) {
							f instanceof w["default"] && f.deleteAt(f.length() - 1, 1);
					...
					value: function() {
						var t = arguments.length <= 0 || void 0 === arguments[0] ? 0 : arguments[0],
							e = arguments.length <= 1 || void 0 === arguments[1] ? Number.MAX_VALUE : arguments[1],
							n = function r(t, e, n) {
								var o = [],
									i = n;
								return t.children.forEachAt(e, n, function(t, e, n) {
									a(t) ? o.push(t) : t instanceof h["default"].Container && (o = o.concat(r(t, e, i))), i -= n
								}), o
							};
						return n(this, t, e)
					}
					...
					value: function() {
						var t = arguments.length <= 0 || void 0 === arguments[0] ? [] : arguments[0];
						this.batch !== !0 && (c(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "optimize", this).call(this, t), t.length > 0 && this.emitter.emit(d["default"].events.SCROLL_OPTIMIZE, t))
					}
				}, {
					key: "path",
					value: function(t) {
		...
		x.blotName = "scroll", x.className = "ql-editor", x.tagName = "DIV", x.defaultChild = "block", x.allowedChildren = [v["default"], y.BlockEmbed, _["default"]], e["default"] = x
	}, function(t, e, n) {
		"use strict";
		...
		function h(t, e, n) {
			return n.compose((new k["default"]).retain(n.length(), o({}, t, !0)))
		}

		function p(t, e) {
			var n = j["default"].Attributor.Attribute.keys(t),
				r = j["default"].Attributor.Class.keys(t),
				o = j["default"].Attributor.Style.keys(t),
				i = {};
			return n.concat(r).concat(o).forEach(function(e) {
				var n = j["default"].query(e, j["default"].Scope.ATTRIBUTE);
				null != n && (i[n.attrName] = n.value(t), i[n.attrName]) || null != H[e] && (n = H[e], i[n.attrName] = n.value(t))
			}), Object.keys(i).length > 0 && (e = e.compose((new k["default"]).retain(e.length(), i))), e
		}

		function d(t, e) {
			var n = j["default"].query(t);
			if (null == n) return e;
			if (n.prototype instanceof j["default"].Embed) {
				var r = {},
					i = n.value(t);
				null != i && (r[n.blotName] = i, e = (new k["default"]).insert(r, n.formats(t)))
			} else if ("function" == typeof n.formats) {
				var l = o({}, n.blotName, n.formats(t));
				e = e.compose((new k["default"]).retain(e.length(), l))
			}
			return e
		}
		...
		function m(t, e) {
			var n = {},
				r = t.style || {};
			return r.fontWeight && "bold" === u(t).fontWeight && (n.bold = !0), Object.keys(n).length > 0 && (e = e.compose((new k["default"]).retain(e.length(), n))), parseFloat(r.textIndent || 0) > 0 && (e = (new k["default"]).insert("\t").concat(e)), e
		}
		...
		var O = function() {
			...
			H = [L.AlignStyle, C.BackgroundStyle, M.ColorStyle, I.DirectionStyle, R.FontStyle, B.SizeStyle].reduce(function(t, e) {
			...
			F = function(t) {
				function e(t, n) {
					...
					return r.quill.root.addEventListener("paste", r.onPaste.bind(r)), r.container = r.quill.addContainer("ql-clipboard"), r.container.setAttribute("contenteditable", !0), r.container.setAttribute("tabindex", -1), r.matchers = [], U.concat(r.options.matchers).forEach(function(t) {
					...
					value: function(t) {
						...
						var i = function a(t) {
								return t.nodeType === t.TEXT_NODE ? r.reduce(function(e, n) {
									return n(t, e)
								}, new k["default"]) : t.nodeType === t.ELEMENT_NODE ? [].reduce.call(t.childNodes || [], function(e, r) {
									var i = a(r);
									return r.nodeType === t.ELEMENT_NODE && (i = o.reduce(function(t, e) {
										return e(r, t)
									}, i), i = (r[n] || []).reduce(function(t, e) {
										return e(r, t)
									}, i)), e.concat(i)
								}, new k["default"]) : new k["default"]
							},
							l = i(this.container);
						return c(l, "\n") && null == l.ops[l.ops.length - 1].attributes && (l = l.compose((new k["default"]).retain(l.length() - 1)["delete"](1))), D.log("convert", this.container.innerHTML, l), this.container.innerHTML = "", l
					}
				}, {
					key: "onPaste",
					value: function(t) {
						...
						if (!t.defaultPrevented) {
							var n = this.quill.getSelection(),
								r = (new k["default"]).retain(n.index)["delete"](n.length),
								o = document.body.scrollTop;
							this.container.focus(), setTimeout(function() {
								r = r.concat(e.convert()), e.quill.updateContents(r, N["default"].sources.USER), e.quill.setSelection(r.length() - n.length, N["default"].sources.SILENT), document.body.scrollTop = o, e.quill.selection.scrollIntoView()
							}, 1)
						}
					}
				}]), e
		...
		F.DEFAULTS = {
			matchers: []
		}, e["default"] = F, e.matchAttributor = p, e.matchBlot = d, e.matchNewline = b, e.matchSpacing = g, e.matchText = _
	}, function(t, e, n) {
		"use strict";
		...
		var o = n(2),
			...
			a = new i["default"].Attributor.Class("align", "ql-align", l),
			s = new i["default"].Attributor.Style("align", "text-align", l);
		e.AlignClass = a, e.AlignStyle = s
	}, function(t, e, n) {
		"use strict";
		...
		var a = function() {
			...
			f = function(t) {
				...
				return l(e, t), a(e, [{
					key: "value",
					value: function n(t) {
						var n = s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "value", this).call(this, t);
						return n.startsWith("rgb(") ? (n = n.replace(/^[^\d]+/, "").replace(/[^\d]+$/, ""), "#" + n.split(",").map(function(t) {
							return ("00" + parseInt(t).toString(16)).slice(-2)
						}).join("")) : n
					}
				}]), e
			}(c["default"].Attributor.Style),
			h = new c["default"].Attributor.Class("color", "ql-color", {
		...
		var o = n(2),
			...
			a = new i["default"].Attributor.Class("direction", "ql-direction", l),
			s = new i["default"].Attributor.Style("direction", "direction", l);
		e.DirectionClass = a, e.DirectionStyle = s
	}, function(t, e, n) {
		"use strict";
		...
		var o = n(2),
			...
			a = new i["default"].Attributor.Class("font", "ql-font", l),
			s = new i["default"].Attributor.Style("font", "font-family", l);
		e.FontStyle = s, e.FontClass = a
	}, function(t, e, n) {
		"use strict";
		...
		function a(t) {
			this.quill.deleteText(t, E["default"].sources.USER), this.quill.setSelection(t.index, E["default"].sources.SILENT), this.quill.selection.scrollIntoView()
		}
		...
		function s(t, e) {
			...
			var r = Object.keys(e.format).reduce(function(t, n) {
				return x["default"].query(n, x["default"].Scope.BLOCK) && !Array.isArray(e.format[n]) && (t[n] = e.format[n]), t
			}, {});
			this.quill.insertText(t.index, "\n", r, E["default"].sources.USER), this.quill.selection.scrollIntoView(), Object.keys(e.format).forEach(function(t) {
				null == r[t] && (Array.isArray(e.format[t]) || "link" !== t && n.quill.format(t, e.format[t], E["default"].sources.USER))
			})
		}
			...
			return {
				...
				handler: function(e) {
					...
					if (null != a) {
						...
						}), this.quill.update(E["default"].sources.USER), this.quill.setSelection(r, o, E["default"].sources.SILENT)
					}
				}
			}
		}
		...
		function c(t) {
			return {
				...
				handler: function(e, n) {
					this.quill.format(t, !n.format[t], E["default"].sources.USER)
				}
			}
		}
		...
		function f(t) {
			...
			if ("object" === ("undefined" == typeof t ? "undefined" : h(t)) && (t = (0, v["default"])(t, !1)), "string" == typeof t.key)
				if (null != L.keys[t.key.toUpperCase()]) t.key = L.keys[t.key.toUpperCase()];
				else {
		...
		var h = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
			...
			q = r(N),
			T = n(32),
			S = (r(T), (0, A["default"])("quill:keyboard")),
			P = /Mac/i.test(navigator.platform) ? "metaKey" : "ctrlKey",
			L = function(t) {
				function e(t, n) {
					o(this, e);
					var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
					return r.bindings = {}, Object.keys(r.options.bindings).forEach(function(t) {
						...
						0 !== t.index && (this.quill.deleteText(t.index - 1, 1, E["default"].sources.USER), this.quill.selection.scrollIntoView())
					}), r.addBinding({
						key: e.keys.DELETE
					}, {
						collapsed: !0,
						...
						t.index >= this.quill.getLength() - 1 || this.quill.deleteText(t.index, 1, E["default"].sources.USER)
					}), r.addBinding({
						key: e.keys.BACKSPACE
					}, {
						collapsed: !1
				...
				return l(e, t), d(e, null, [{
					key: "match",
					value: function(t, e) {
						return e = f(e), (!!e.shortKey === t[P] || null === e.shortKey) && (!["altKey", "ctrlKey", "metaKey", "shiftKey"].some(function(n) {
							return n != P && !!e[n] !== t[n] && null !== e[n]
					...
					value: function(t) {
						var e = arguments.length <= 1 || void 0 === arguments[1] ? {} : arguments[1],
							...
							r = f(t);
						return null == r || null == r.key ? S.warn("Attempted to add invalid keyboard binding", r) : ("function" == typeof e && (e = {
							handler: e
						}), "function" == typeof n && (n = {
							handler: n
						}), r = (0, _["default"])(r, e, n), this.bindings[r.key] = this.bindings[r.key] || [], void this.bindings[r.key].push(r))
					}
				}, {
					key: "listen",
					value: function() {
								...
								if (0 !== o.length) {
									...
									if (null != i) {
										var l = t.quill.scroll.line(i.index),
											...
											d = f[0],
											y = f[1],
											v = 0 === i.length ? [d, y] : t.quill.scroll.leaf(i.index + i.length),
											b = p(v, 2),
											m = b[0],
											_ = b[1],
											O = d instanceof x["default"].Text ? d.value().slice(0, y) : "",
											w = m instanceof x["default"].Text ? m.value().slice(_) : "",
											k = {
											...
											E = o.some(function(e) {
												...
												if (Array.isArray(e.format)) {
													if (e.format.every(function(t) {
														...
														return e.format[t] === !0 ? null != k.format[t] : e.format[t] === !1 ? null == k.format[t] : (0, g["default"])(e.format[t], k.format[t])
													})) return !1;
												return !(null != e.prefix && !e.prefix.test(k.prefix)) && (!(null != e.suffix && !e.suffix.test(k.suffix)) && e.handler.call(t, i, k) !== !0)
											});
										E && n.preventDefault()
									}
								}
			...
			bindings: {
				...
				indent: {
					...
					handler: function(t, e) {
						return !(!e.collapsed || 0 === e.offset) || void this.quill.format("indent", "+1", E["default"].sources.USER)
					}
				},
				outdent: {
					key: L.keys.TAB,
				...
				"outdent backspace": {
					key: L.keys.BACKSPACE,
					collapsed: !0,
					format: ["blockquote", "indent", "list"],
					offset: 0,
					handler: function(t, e) {
						null != e.format.indent ? this.quill.format("indent", "-1", E["default"].sources.USER) : null != e.format.blockquote ? this.quill.format("blockquote", !1, E["default"].sources.USER) : null != e.format.list && this.quill.format("list", !1, E["default"].sources.USER)
					}
				},
				...
				"remove tab": {
					...
					prefix: /\t$/,
					handler: function(t, e) {
						this.quill.deleteText(t.index - 1, 1, E["default"].sources.USER)
					}
				},
				tab: {
					key: L.keys.TAB,
					handler: function(t, e) {
						e.collapsed || this.quill.scroll.deleteAt(t.index, t.length), this.quill.insertText(t.index, "\t", E["default"].sources.USER), this.quill.setSelection(t.index + 1, E["default"].sources.SILENT)
					}
				},
				"list empty enter": {
					key: L.keys.ENTER,
					...
					empty: !0,
					handler: function(t, e) {
						this.quill.format("list", !1, E["default"].sources.USER), e.format.indent && this.quill.format("indent", !1, E["default"].sources.USER)
					}
				},
				"header enter": {
					key: L.keys.ENTER,
					...
					suffix: /^$/,
					handler: function(t) {
						this.quill.scroll.insertAt(t.index, "\n"), this.quill.formatText(t.index + 1, 1, "header", !1, E["default"].sources.USER), this.quill.setSelection(t.index + 1, E["default"].sources.SILENT), this.quill.selection.scrollIntoView()
					}
				},
				"list autofill": {
					key: " ",
					...
					handler: function(t, e) {
						...
						this.quill.scroll.deleteAt(t.index - n, n), this.quill.formatLine(t.index - n, 1, "list", 1 === n ? "bullet" : "ordered", E["default"].sources.USER), this.quill.setSelection(t.index - n, E["default"].sources.SILENT)
					}
				}
			}
		}, e["default"] = L
			...
			f = function(t) {
				...
				return l(e, t), a(e, [{
					...
					value: function(t, n) {
						...
						return 0 === n ? (this.remove(t), !0) : s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "add", this).call(this, t, n)
					}
				}, {
					key: "value",
					value: function(t) {
						return parseInt(s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "value", this).call(this, t)) || void 0
					}
				}]), e
			}(c["default"].Attributor.Class),
			h = new f("indent", "ql-indent", {
				scope: c["default"].Scope.BLOCK,
		...
		c.blotName = "header", c.tagName = ["H1", "H2", "H3", "H4", "H5", "H6"], e["default"] = c
	}, function(t, e, n) {
		"use strict";
		...
		var s = function() {
			...
			g = function(t) {
				...
				return a(e, t), s(e, [{
					key: "format",
					value: function(t, n) {
						t !== m.blotName || n ? u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "format", this).call(this, t, n) : this.replaceWith(p["default"].create(this.statics.scope))
					}
				}, {
					key: "remove",
					value: function() {
		...
		var m = function(t) {
			...
			return a(e, t), s(e, [{
				...
				key: "insertBefore",
				value: function(t, n) {
					if (t instanceof g) u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "insertBefore", this).call(this, t, n);
					else {
				...
				value: function(t) {
					if (t.statics.blotName !== this.statics.blotName) {
						var n = p["default"].create(this.statics.defaultChild);
		...
		m.blotName = "list", m.scope = p["default"].Scope.BLOCK_BLOT, m.tagName = ["OL", "UL"], m.defaultChild = "list-item", m.allowedChildren = [g], e.ListItem = g, e["default"] = m
	}, function(t, e, n) {
		"use strict";
		...
		var a = function() {
			...
			f = function(t) {
				...
				return l(e, t), a(e, [{
					key: "optimize",
					value: function() {
						s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "optimize", this).call(this), this.domNode.tagName !== this.statics.tagName[0] && this.replaceWith(this.statics.blotName)
					}
				}], [{
					key: "create",
					value: function(t) {
						return s(e.__proto__ || Object.getPrototypeOf(e), "create", this).call(this)
					}
				}, {
					key: "formats",
					value: function(t) {
		...
		f.blotName = "bold", f.tagName = ["STRONG", "B"], e["default"] = f
	}, function(t, e, n) {
		"use strict";
		...
		var s = function() {
			...
			h = function(t) {
				...
				return l(e, t), s(e, [{
					key: "format",
					value: function(t, n) {
						return t === this.statics.blotName && n ? (n = this.constructor.sanitize(n), void this.domNode.setAttribute("href", n)) : u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "format", this).call(this, t, n)
					}
				}], [{
					key: "create",
					value: function(t) {
					...
					key: "sanitize",
					value: function(t) {
						return a(t, ["http", "https", "mailto"]) ? t : this.SANITIZED_URL
					}
				}]), e
			}(f["default"]);
		h.blotName = "link", h.tagName = "A", h.SANITIZED_URL = "about:blank", e["default"] = h, e.sanitize = a
	}, function(t, e, n) {
		"use strict";
		...
		var a = function() {
			...
			f = function(t) {
				...
				return l(e, t), a(e, null, [{
					key: "create",
					value: function(t) {
						return "super" === t ? document.createElement("sup") : "sub" === t ? document.createElement("sub") : s(e.__proto__ || Object.getPrototypeOf(e), "create", this).call(this, t)
					}
				}, {
					key: "formats",
					value: function(t) {
		...
		f.blotName = "script", f.tagName = ["SUB", "SUP"], e["default"] = f
	}, function(t, e, n) {
		"use strict";
		...
		var a = function() {
			...
			h = (r(f), function(t) {
				...
				return l(e, t), a(e, [{
					...
					value: function n(t) {
						var n = {};
						return t.hasAttribute("height") && (n.height = t.getAttribute("height")), t.hasAttribute("width") && (n.width = t.getAttribute("width")), n
					}
				}, {
					key: "match",
					value: function(t) {
					...
					key: "sanitize",
					value: function(t) {
						return (0, f.sanitize)(t, ["http", "https", "data"]) ? t : "//:0"
					}
				}, {
					key: "value",
					value: function(t) {
		...
		d.blotName = "formula", d.className = "ql-formula", d.tagName = "SPAN", e.FormulaBlot = d, e["default"] = a
	}, function(t, e, n) {
		"use strict";
		...
		function c(t, e, n) {
			...
			r.classList.add("ql-" + e), n.forEach(function(t) {
				...
				t !== !1 ? e.setAttribute("value", t) : e.setAttribute("selected", "selected"), r.appendChild(e)
			}), t.appendChild(r)
		}
		Object.defineProperty(e, "__esModule", {
			value: !0
					...
					value: function(t) {
						...
						if (n) {
							if (n = n.slice("ql-".length), "BUTTON" === t.tagName && t.setAttribute("type", "button"), null == this.handlers[n]) {
								if (null != this.quill.scroll.whitelist && null == this.quill.scroll.whitelist[n]) return void k.warn("ignoring attaching to disabled format", n, t);
								if (null == b["default"].query(n)) return void k.warn("ignoring attaching to nonexistent format", n, t)
							}
							...
							t.addEventListener(r, function(r) {
								...
								if (null != e.handlers[n]) e.handlers[n].call(e, i);
									...
									e.quill.updateContents((new y["default"]).retain(u.index)["delete"](u.length).insert(o({}, n, i)), m["default"].sources.USER)
		...
		E.DEFAULTS = {}, E.DEFAULTS = {
			...
			handlers: {
					...
					if (null != n)
						if (0 == n.length) {
							...
							Object.keys(r).forEach(function(t) {
								null != b["default"].query(t, b["default"].Scope.INLINE) && e.quill.format(t, !1)
							})
						} else this.quill.removeFormat(n, m["default"].sources.USER)
				},
				...
				link: function(t) {
					t === !0 && (t = prompt("Enter link URL:")), this.quill.format("link", t, m["default"].sources.USER)
				},
				indent: function j(t) {
					var e = this.quill.getSelection(),
						n = this.quill.getFormat(e),
						j = parseInt(n.indent || 0);
					if ("+1" === t || "-1" === t) {
						var r = "+1" === t ? 1 : -1;
						"rtl" === n.direction && (r *= -1), this.quill.format("indent", j + r, m["default"].sources.USER)
					}
				}
			}
		...
		var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
			...
			u = function() {
				function t(e) {
					var n = this;
					o(this, t), this.select = e, this.container = document.createElement("span"), this.buildPicker(), this.select.style.display = "none", this.select.parentNode.insertBefore(this.container, this.select), this.label.addEventListener("click", function(t) {
				...
				return l(t, [{
					...
					value: function() {
						...
						return t.classList.add("ql-picker-label"), t.innerHTML = s["default"], this.container.appendChild(t), t
					}
				}, {
					key: "buildOptions",
					value: function() {
		...
		var a = function() {
			...
			f = function(t) {
				...
				return l(e, t), a(e, [{
					key: "buildItem",
					value: function(t) {
						var n = s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "buildItem", this).call(this, t);
						return n.style.backgroundColor = t.getAttribute("value") || "", n
					}
				}, {
					key: "selectItem",
					value: function(t, n) {
						s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "selectItem", this).call(this, t, n);
		...
		var a = function() {
			...
			f = function(t) {
				...
				return l(e, t), a(e, [{
					key: "selectItem",
					value: function(t, n) {
						s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "selectItem", this).call(this, t, n), t = t || this.defaultItem, this.label.innerHTML = t.innerHTML
					}
				}]), e
			}(c["default"]);
		e["default"] = f
		...
		var a = function O(t, e, n) {
				null === t && (t = Function.prototype);
				var r = Object.getOwnPropertyDescriptor(t, e);
				if (void 0 === r) {
					var o = Object.getPrototypeOf(t);
					return null === o ? void 0 : O(o, e, n)
				}
				if ("value" in r) return r.value;
				var i = r.get;
				if (void 0 !== i) return i.call(n)
			...
			m = function(t) {
				...
				return l(e, t), s(e, [{
					key: "extendToolbar",
					value: function(t) {
						this.tooltip = new _(this.quill, this.options.bounds), this.tooltip.root.appendChild(t.container), this.buildButtons([].slice.call(t.container.querySelectorAll("button"))), this.buildPickers([].slice.call(t.container.querySelectorAll("select")))
					}
				}]), e
			}(y["default"]);
		m.DEFAULTS = (0, c["default"])(!0, {}, d.BaseTooltip.DEFAULTS, {
			modules: {
				toolbar: {
					handlers: {
						link: function(t) {
		...
		var _ = function(t) {
			function e(t, n) {
				o(this, e);
				var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
				return r.quill.on(h["default"].events.EDITOR_CHANGE, function(t, e) {
						...
						if (null != e && e.length > 0) {
							...
							if (1 === n.length) r.position(r.quill.getBounds(e));
								...
								var o = n[n.length - 1],
									...
									a = r.quill.getBounds(new b.Range(i, l));
								r.position(a)
							}
		...
		_.TEMPLATE = ['<span class="ql-tooltip-arrow"></span>', '<div class="ql-tooltip-editor">', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="ql-close"></a>', "</div>"].join(""), e["default"] = m
	}, function(t, e, n) {
		"use strict";
		...
		var s = function() {
			...
			M = function(t) {
				function e(t, n) {
					...
					var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n)),
						l = function a(e) {
							return document.body.contains(t.root) ? (null == r.tooltip || r.tooltip.root.contains(e.target) || document.activeElement === r.tooltip.textbox || r.quill.hasFocus() || r.tooltip.hide(), void(null != r.pickers && r.pickers.forEach(function(t) {
								t.container.contains(e.target) || t.close()
							}))) : document.body.removeEventListener("click", a)
						};
					return document.body.addEventListener("click", l), r
				}
				return l(e, t), s(e, [{
					key: "addModule",
					value: function(t) {
					...
					value: function(t) {
						t.forEach(function(t) {
							...
							e.split(/\s+/).forEach(function(e) {
								if (e.startsWith("ql-") && (e = e.slice("ql-".length), null != q["default"][e]))
									if ("direction" === e) t.innerHTML = q["default"][e][""] + q["default"][e].rtl;
									else if ("string" == typeof q["default"][e]) t.innerHTML = q["default"][e];
								else {
									var n = t.value || "";
									null != n && q["default"][e][n] && (t.innerHTML = q["default"][e][n])
								}
							})
						})
					}
					...
					value: function(t) {
						...
						this.pickers = t.map(function(t) {
							if (t.classList.contains("ql-align")) return null == t.querySelector("option") && a(t, T), new x["default"](t, q["default"].align);
							if (t.classList.contains("ql-background") || t.classList.contains("ql-color")) {
								...
								return null == t.querySelector("option") && a(t, S, "background" === e ? "#ffffff" : "#000000"), new O["default"](t, q["default"][e])
							}
							return null == t.querySelector("option") && (t.classList.contains("ql-font") ? a(t, P) : t.classList.contains("ql-header") ? a(t, L) : t.classList.contains("ql-size") && a(t, C)), new E["default"](t)
						});
						var n = function() {
						...
						this.quill.on(y["default"].events.SELECTION_CHANGE, n).on(y["default"].events.SCROLL_OPTIMIZE, n)
					}
				}]), e
			}(m["default"]);
		M.DEFAULTS = (0, f["default"])(!0, {}, m["default"].DEFAULTS, {
			modules: {
				toolbar: {
					handlers: {
						formula: function(t) {
						...
						image: function(t) {
							...
							null == n && (n = document.createElement("input"), n.setAttribute("type", "file"), n.setAttribute("accept", "image/*"), n.classList.add("ql-image"), n.addEventListener("change", function() {
								if (null != n.files && null != n.files[0]) {
									...
									t.onload = function(t) {
										...
										}), y["default"].sources.USER), n.value = ""
			...
			return l(e, t), s(e, [{
				...
				value: function() {
					...
					this.textbox.addEventListener("keydown", function(e) {
						b["default"].match(e, "enter") ? (t.save(), e.preventDefault()) : b["default"].match(e, "escape") && (t.cancel(), e.preventDefault())
					})
				}
			}, {
				key: "cancel",
				...
				value: function() {
					...
					switch (this.root.getAttribute("data-mode")) {
						case "link":
							...
							this.linkRange ? (this.quill.formatText(this.linkRange, "link", t, y["default"].sources.USER), delete this.linkRange) : (this.restoreFocus(), this.quill.format("link", t, y["default"].sources.USER)), this.quill.root.scrollTop = e;
							break;
						case "video":
						...
						case "formula":
							var r = this.quill.getSelection(!0),
								o = r.index + r.length;
							null != r && (this.quill.insertEmbed(o, this.root.getAttribute("data-mode"), t, y["default"].sources.USER), "formula" === this.root.getAttribute("data-mode") && this.quill.insertText(o + 1, " ", y["default"].sources.USER), this.quill.setSelection(o + 2, y["default"].sources.USER))
					}
					this.textbox.value = "", this.hide()
				}
			}]), e
		}(A["default"]);
		e.BaseTooltip = I, e["default"] = M
	}, function(t, e, n) {
		"use strict";
		...
		var a = function() {
			...
			O = function(t) {
				function e(t, n) {
					o(this, e), null != n.modules.toolbar && null == n.modules.toolbar.container && (n.modules.toolbar.container = _);
					var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
				...
				return l(e, t), u(e, [{
					key: "extendToolbar",
					value: function(t) {
						t.container.classList.add("ql-snow"), this.buildButtons([].slice.call(t.container.querySelectorAll("button"))), this.buildPickers([].slice.call(t.container.querySelectorAll("select"))), this.tooltip = new w(this.quill, this.options.bounds), t.container.querySelector(".ql-link") && this.quill.keyboard.addBinding({
							key: "K",
							shortKey: !0
						}, function(e, n) {
			...
			return l(e, t), u(e, [{
				...
				value: function() {
					...
					s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "listen", this).call(this), this.root.querySelector("a.ql-action").addEventListener("click", function(e) {
						...
						null != t.linkRange && (t.restoreFocus(), t.quill.formatText(t.linkRange, "link", !1, p["default"].sources.USER), delete t.linkRange), e.preventDefault(), t.hide()
					}), this.quill.on(p["default"].events.SELECTION_CHANGE, function(e) {
						if (null != e) {
							if (0 === e.length) {
								var n = t.quill.scroll.descendant(b["default"], e.index),
									r = a(n, 2),
									o = r[0],
									i = r[1];
								if (null != o) {
									t.linkRange = new m.Range(e.index - i, o.length());
									var l = b["default"].formats(o.domNode);
		...
		w.TEMPLATE = ['<a class="ql-preview" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join(""), e["default"] = O
	}])
});
